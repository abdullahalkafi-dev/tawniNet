...
class UserCustomerServiceView extends StatefulWidget {
  const UserCustomerServiceView({super.key});

  @override
  State<UserCustomerServiceView> createState() => _UserCustomerServiceViewState();
}

class _UserCustomerServiceViewState extends State<UserCustomerServiceView> {
